...
void mrg::Viewer::CreateVulkanInstance()
{
    ...
    appInfo.pApplicationName = "Mirage Viewer";
...
void mrg::Viewer::CreateSwapChain()
{
...
VkSurfaceFormatKHR mrg::Viewer::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR mrg::Viewer::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D mrg::Viewer::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void mrg::Viewer::CreateImageViews()
{
...
void mrg::Viewer::CreateDescriptorSetLayout()
{
...
void mrg::Viewer::CreateGraphicsPipeline()
{
...
VkShaderModule mrg::Viewer::CreateShaderModule(const std::vector<char>& code)
{
...
void mrg::Viewer::CreateRenderPass()
{
...
void mrg::Viewer::CreateFramebuffers()
{
...
void mrg::Viewer::CreateCommandPool()
{
...
void mrg::Viewer::CreateTextureImageView()
{
    textureImageView = CreateImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM);
}

VkImageView mrg::Viewer::CreateImageView(VkImage image, VkFormat format)
{
...
void mrg::Viewer::CreateTextureSampler()
{
...
void mrg::Viewer::CreateImage(uint32_t width, uint32_t height, VkFormat format,
...
VkCommandBuffer mrg::Viewer::BeginSingleTimeCommands()
{
...
void mrg::Viewer::EndSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void mrg::Viewer::CreateVertexBuffer()
{
...
void mrg::Viewer::CreateIndexBuffer()
{
...
void mrg::Viewer::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
...
void::mrg::Viewer::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
void mrg::Viewer::CreateBuffer(VkDeviceSize size,
...
void mrg::Viewer::CopyBuffer(VkBuffer srcBuffer,
        VkBuffer dstBuffer,
        VkDeviceSize size)
{
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
...
void mrg::Viewer::CreateDescriptorPool()
{
...
void mrg::Viewer::CreateDescriptorSets()
{
...
void mrg::Viewer::CreateCommandBuffers()
{
